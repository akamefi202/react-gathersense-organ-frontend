                            ...
                            <TableBody>
                                <TableRow hover role="checkbox" tabIndex={-1}>
                                    ...
                                    <TableCell align="right">
                                        <Button onClick={this.handleAnchor} style={{marginLeft: '15px', borderRadius: '30px', color: '#009FFA', backgroundColor: 'rgba(0, 159, 250, 0.1)', borderWidth: '0px'}}> 
                                            Add Candidates 
                                        </Button>
                                        <Button onClick={() => this.handleClickEdit(this.state.email)} style={{marginLeft: '15px', borderRadius: '30px', color: '#009FFA', backgroundColor: 'rgba(0, 159, 250, 0.1)', borderWidth: '0px'}}> 
                                            Edit 
                                        </Button> 
                                        <Button onClick={() => this.handleClickDelete(this.state.email)} style={{marginLeft: '15px', borderRadius: '30px', color: '#F11564', backgroundColor: '#FFEDED', borderWidth: '0px'}} > 
                                            Delete 
                                        </Button>
                                    </TableCell>
                                </TableRow>
