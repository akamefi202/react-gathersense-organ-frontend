...
const dataOrg = {
    ...
    country: [
        { label: 'Trial', population: 710249, capital: 'Juneau', region: 'West' },
        { label: 'Logic', population: 6392307, capital: 'Phoenix', region: 'West' },
        { label: 'knowledge', population: 6392307, capital: 'Phoenix', region: 'West' },
    ],
